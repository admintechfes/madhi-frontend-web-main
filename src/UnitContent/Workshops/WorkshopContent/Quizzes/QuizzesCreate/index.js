...
import { deleteSelectedQuestionnnaire, resetSelectedQuestionnaire, setQuizForm, setSelectedQuestionnaire, skipSelectedQuestion, handleWeightage } from '../../../duck/workshopContentSlice';
		...
		<>
			...
			{openDeleteDialog && (
				<DeleteDialog open={openDeleteDialog} loading={false} close={handleClose} delete={handleDeleteConfirm} title="Delete Question">
					<p>Are you sure? This will remove this question</p>
				</DeleteDialog>
			)}
		</>
	);
