...
export const manualWhatsAppSlice = createSlice({
	name: 'manualWhatsApp',
	initialState,
	reducers: {
    ...
    fillWhatsappStartDateValue: (state, action) => {
      state.startDateValue = action.payload
    },
    fillWhatsappEndDateValue: (state, action) => {
      state.endDateValue = action.payload
		...
		fillWhatsAppStatusNew:(state,action)=>{
			state.whatsAppStatusNew=action.payload
		},
...
export const {
	...
	setPaginationPage,
  fillWhatsappEndDateValue,
  fillFilterData,
  fillWhatsappStartDateValue,
  fillTagsFilter,
	...
	fillApplyFilter,
	setLoadingUser,
} = manualWhatsAppSlice.actions;

export default manualWhatsAppSlice.reducer;
