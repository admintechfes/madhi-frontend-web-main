...
import { fillFilterData, fillTagsFilter, fillApplyFilter, fillWhatsappStartDateValue, fillWhatsappEndDateValue } from './duck/manualWhatsAppSlice';

export default function ManualWhatsAppFilter({
	handleClose,
	anchorEl,
	page,
	setAnchorEl,
