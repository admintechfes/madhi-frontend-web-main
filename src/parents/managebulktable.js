                              ...
                              <StyledTableCell key={index} align={value.align ? value.align : 'left'}>
                                <div className="tw-flex tw-gap-4 tw-items-center">
                                  <Button
                                    ...
                                    onClick={() => navigate('/parents/manage-bulk/parents-added', { state: { bulk_upload_id: row.id } })}
                                  >
                                    View Parents updated
                                  </Button>
                                  <Button onClick={() => navigate("/parents/manage-bulk/view-errors", { state: { bulk_upload_id: row.id } })}
