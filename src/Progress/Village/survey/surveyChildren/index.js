...
export default function SurveyChildren() {
	...
	const { progressName, name, villageAreaId, conductedById,parentId, programUnitContentId, programId, unitId, moderatedById, programUnitId } = location.state || {};
	...
	const onNavigateDetails = (data) => {
			navigate('/progress/village/survey-details/preview', { state: { parentId: data.parentId, progressName, name, villageAreaId, conductedById, programUnitContentId, surveyNumber: surveyDetails.surveyNumber,childId:data?.childId } });
	};
