                  ...
                  return (
                    ...
                    >
                      {Object.values(props.columns).map((value, index) => {
                        ...
                        if (value.id === 'status') {
                          let BackgroundTheme = row[value.id]?.toLowerCase() === 'completed' ? '#57C79633' : row[value.id]?.toLowerCase() === 'to be redone' ? '#FFC40C33' : '#DDDDDD';
                          let ColorTheme = row[value.id]?.toLowerCase() === 'completed' ? '#57C796' : row[value.id]?.toLowerCase() === 'to be redone' ? '#F39C35' : '#666666';
                          return (
